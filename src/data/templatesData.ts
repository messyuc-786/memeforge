...
export const MEME_TEMPLATES: MemeTemplate[] = [
  ...
  },
  {
    ...
    category: 'Reaction',
    aspectRatio: '16:9',
    tags: ['doge', 'cheems', 'buff', 'past', 'present', 'weak'],
    defaultTopText: 'PROGRAMMERS IN 1969: SENT HUMANS TO THE MOON WITH 4KB OF RAM',
    defaultBottomText: 'PROGRAMMERS IN 2026: MY CODE BROKE BECAUSE I MISSED A SEMICOLON 😭',
    previewUrl: createTemplateSvg(`
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 450">
        <rect width="400" height="450" fill="#1E293B"/>
        <rect x="400" width="400" height="450" fill="#0F172A"/>
        <line x1="400" y1="0" x2="400" y2="450" stroke="#334155" stroke-width="4"/>
        <!-- Buff Doge Left -->
        <rect x="120" y="140" width="160" height="200" rx="40" fill="#E6C280" stroke="#C49A45" stroke-width="4"/>
        <circle cx="200" cy="110" r="45" fill="#E6C280"/>
        <text x="200" y="380" font-family="Impact" font-size="26" fill="#FDE047" text-anchor="middle">💪 BUFF DOGE (1969)</text>
        <!-- Crying Tiny Cheems Right -->
        <ellipse cx="600" cy="270" rx="55" ry="40" fill="#E6C280"/>
        <circle cx="570" cy="230" r="30" fill="#E6C280"/>
        <text x="600" y="380" font-family="Impact" font-size="26" fill="#F87171" text-anchor="middle">🥺 CHEEMS (NOW)</text>
      </svg>
    `)
  },
  {
    ...
    category: 'Reaction',
    aspectRatio: '1:1',
    tags: ['panik', 'kalm', 'meme-man', 'stress', 'crisis'],
    defaultTopText: 'PANIK: PRODUCTION IS DOWN',
    defaultBottomText: 'KALM: IT IS WORKING ON MY LOCALHOST',
    previewUrl: createTemplateSvg(`
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 600">
        <rect x="0" y="0" width="600" height="200" fill="#7F1D1D"/>
        <text x="50" y="110" font-family="Impact" font-size="34" fill="#FECACA">1. PANIK 😱</text>
        <rect x="0" y="200" width="600" height="200" fill="#064E3B"/>
        <text x="50" y="310" font-family="Impact" font-size="34" fill="#A7F3D0">2. KALM 😌</text>
        <rect x="0" y="400" width="600" height="200" fill="#991B1B"/>
        <text x="50" y="510" font-family="Impact" font-size="34" fill="#FECACA">3. PANIK AGAIN 💀</text>
        <line x1="0" y1="200" x2="600" y2="200" stroke="#FFF" stroke-width="3"/>
        <line x1="0" y1="400" x2="600" y2="400" stroke="#FFF" stroke-width="3"/>
      </svg>
    `)
  },
  {
    id: 'two-buttons-choice',
    title: 'Sweating Guy Pressing Two Buttons',
    category: 'Everyday Life',
    aspectRatio: '1:1',
    tags: ['buttons', 'choice', 'sweat', 'decision', 'hard'],
    defaultTopText: 'GO TO BED AT A REASONABLE HOUR',
    defaultBottomText: 'WATCH 4 HOURS OF HYPOTHETICAL CRAB FIGHT VIDEOS',
    previewUrl: createTemplateSvg(`
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 600">
        <rect width="600" height="600" fill="#18181B"/>
        <!-- Control Panel with 2 Red Buttons -->
        <rect x="60" y="80" width="480" height="200" rx="16" fill="#27272A" stroke="#52525B" stroke-width="4"/>
        <circle cx="180" cy="180" r="50" fill="#EF4444" stroke="#B91C1C" stroke-width="6"/>
        <circle cx="420" cy="180" r="50" fill="#EF4444" stroke="#B91C1C" stroke-width="6"/>
        <!-- Sweating Face -->
        <circle cx="300" cy="420" r="70" fill="#FDE047"/>
        <circle cx="270" cy="405" r="8" fill="#000"/>
        <circle cx="330" cy="405" r="8" fill="#000"/>
        <!-- Sweat drops -->
        <ellipse cx="230" cy="380" rx="8" ry="14" fill="#38BDF8"/>
        <ellipse cx="370" cy="380" rx="8" ry="14" fill="#38BDF8"/>
        <path d="M280,450 Q300,430 320,450" fill="none" stroke="#000" stroke-width="4"/>
      </svg>
    `)
  },
  {
    ...
    category: 'Gaming',
    aspectRatio: '1:1',
    tags: ['uno', 'cards', 'admit', 'stubborn', 'gaming'],
    defaultTopText: 'ADMIT YOU WERE WRONG IN THE ARGUMENT',
    defaultBottomText: 'OR DRAW 25 CARDS (CURRENT HAND: 25 CARDS)',
    previewUrl: createTemplateSvg(`
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 600">
        <rect x="0" y="0" width="300" height="600" fill="#DC2626"/>
        <rect x="300" y="0" width="300" height="600" fill="#1E293B"/>
        <line x1="300" y1="0" x2="300" y2="600" stroke="#FFF" stroke-width="4"/>
        <!-- Uno Card Left -->
        <rect x="40" y="160" width="220" height="280" rx="16" fill="#FFF"/>
        <ellipse cx="150" cy="300" rx="80" ry="100" fill="#DC2626"/>
        <text x="150" y="320" font-family="Impact" font-size="38" fill="#FFF" text-anchor="middle">UNO</text>
        <!-- Guy Holding 25 Cards Right -->
        <circle cx="450" cy="220" r="50" fill="#FDE047"/>
        <rect x="360" y="320" width="180" height="140" rx="10" fill="#F59E0B"/>
        <text x="450" y="390" font-family="Impact" font-size="34" fill="#000" text-anchor="middle">+25 CARDS</text>
      </svg>
    `)
  },
  {
    ...
    category: 'Everyday Life',
    aspectRatio: '1:1',
    tags: ['trade', 'offer', 'deal', 'receive', 'business'],
    defaultTopText: '⚠️ TRADE OFFER ⚠️',
    defaultBottomText: 'I RECEIVE: YOUR ATTENTION • YOU RECEIVE: TOP TIER MEMES',
    previewUrl: createTemplateSvg(`
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 600">
        <rect width="600" height="600" fill="#090D16"/>
        <!-- Banner -->
        <rect x="50" y="40" width="500" height="80" rx="16" fill="#F59E0B"/>
        <text x="300" y="95" font-family="Impact" font-size="36" fill="#000" text-anchor="middle">⚠️ TRADE OFFER ⚠️</text>
        <!-- Guy in Suit in Middle -->
        <circle cx="300" cy="260" r="55" fill="#FDE047"/>
        <polygon points="230,360 370,360 300,500" fill="#1E293B"/>
        <rect x="290" y="360" width="20" height="80" fill="#EF4444"/>
        <!-- Two Offer Columns -->
        <text x="160" y="440" font-family="Impact" font-size="22" fill="#38BDF8" text-anchor="middle">I RECEIVE:</text>
        <text x="440" y="440" font-family="Impact" font-size="22" fill="#34D399" text-anchor="middle">YOU RECEIVE:</text>
      </svg>
    `)
  },
  {
